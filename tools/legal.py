...
<h2>Avisos de caducidad de la ITV</h2>
<p>Si dejas tu coche en nuestro taller, en la ficha de recepción te preguntamos, en una casilla aparte y que no viene marcada, si quieres que te avisemos por WhatsApp cuando se acerque la fecha de caducidad de la ITV de tu coche. Solo si la marcas usamos tu nombre, tu teléfono, la matrícula, el modelo y la fecha de caducidad de la ITV para escribirte unos 30 días y 7 días antes (y, si ya ha caducado, una vez más) ofreciéndote la revisión Pre-ITV. La base legal es tu consentimiento (art. 6.1.a del RGPD y art. 21 de la Ley 34/2002 de servicios de la sociedad de la información). No marcarla no afecta a la reparación. Puedes darte de baja en cualquier momento contestando «BAJA» a cualquiera de estos mensajes o escribiéndonos a <a href="mailto:volcanocars2026@gmail.com">volcanocars2026@gmail.com</a>, y dejaremos de enviártelos.</p>
