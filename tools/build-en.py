...
TEXT = {
    ...
    "Solo en Monza Car": "Only at Monza Car",
    ...
    "llegados": "arrived",
    "meses": "months",
    "por llevarte el coche a casa, pedir presupuesto o tasar el tuyo": "to deliver your car, quote a repair or value yours",
    "puntos": "points",
    "recientemente": "sold",
...
RAW = [
    ...
    ('content="Monza Car: los mejores coches de ocasión en Fuerteventura, revisados en nuestro taller y con 1 año de garantía. Entrega a domicilio gratis en toda la isla. Chapa y pintura y mecánica rápida en Antigua con cita online al momento."',
     'content="Monza Car: the best used cars in Fuerteventura, checked in our own workshop with a 1-year warranty and free home delivery anywhere on the island. Body repair, paint and quick servicing in Antigua, near Caleta de Fuste, with instant online booking. We speak English."'),
    ...
    ('"description":"Chapa y pintura, mecánica rápida y compraventa de coches de ocasión revisados con 12 meses de garantía y entrega a domicilio gratis en toda Fuerteventura."',
